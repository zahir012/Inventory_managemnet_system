$(document).ready(function(){
    ...
    $(".datetimeinput").datepicker({changeYear: true,changeMonth: true, dateFormat: 'yy-mm-dd'});
        ...
        $('#id_line_one_quantity, #id_line_one_unit_price, #id_line_two_quantity, #id_line_two_unit_price, #id_line_three_quantity, #id_line_three_unit_price, #id_line_four_quantity, #id_line_four_unit_price, #id_line_five_quantity, #id_line_five_unit_price, #id_line_six_quantity, #id_line_six_unit_price, #id_line_seven_quantity, #id_line_seven_unit_price, #id_line_eight_quantity, #id_line_eight_unit_price #id_line_nine_quantity, #id_line_nine_unit_price, #id_line_ten_quantity, #id_line_ten_unit_price,#id_line_elaven_quantity,#id_line_elaven_unit_price').keyup(function(){
            ...
            var line_elaven_quantiy_text = $('#id_line_elaven_quantiy').val();
            var line_elaven_unit_price_text = $('#id_line_elaven_unit_price').val();
            var line_elaven_total = line_elaven_quantiy_text * line_elaven_unit_price_text
            ...
            $('#id_line_elaven_total_price').val(line_elaven_total);
            $('#id_total').val(total);
        });
